...
// source: GpbElementInfoTest.proto

#define INTERNAL_SUPPRESS_PROTOBUF_FIELD_DEPRECATION
#include "GpbElementInfoTest.pb.h"
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_GpbElementInfoTest_2eproto);
}
...
void protobuf_ShutdownFile_GpbElementInfoTest_2eproto() {
...
struct StaticDescriptorInitializer_GpbElementInfoTest_2eproto {
  StaticDescriptorInitializer_GpbElementInfoTest_2eproto() {
    protobuf_AddDesc_GpbElementInfoTest_2eproto();
  }
} static_descriptor_initializer_GpbElementInfoTest_2eproto_;
...
const Person_PhoneNumber& Person_PhoneNumber::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_GpbElementInfoTest_2eproto();
