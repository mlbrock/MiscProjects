...
struct BaseFName {
	BaseFName(const char *funcdname, const char *funcsig, const char *function)
		,funcdname_((funcdname) ? funcdname : "")
		,funcsig_((funcsig) ? funcsig : "")
		,function_((function) ? function : "")
	{
	}

	std::string funcdname_;
	std::string funcsig_;
	std::string function_;
};

struct ThisFName : public BaseFName {
	ThisFName()
		:BaseFName(__FUNCDNAME__, FUNCSIG__, __FUNCTION__)
